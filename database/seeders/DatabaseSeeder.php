...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        // ]);
        MallList::insert([
            'namaMall' => 'Royal Plaza Surabaya', 'alamatMall' => 'Jl. A Yani No. 16-18, Wonokromo, Kota Surabaya', 'openTimeMall' => '11:00 - 22:00', 'fotoMall' => 'http://onparking.sks-pens.site/img/royal-plaza.jpg', 'kuotaMall' => 1
        ]);
        MallList::insert([
            ['namaMall' => 'Grand City Mall Surabaya', 'alamatMall' => 'Jl. Walikota Mustajab No.1, Ketabang, Kec. Genteng, Kota Surabaya', 'openTimeMall' => '11:00 - 21:00', 'fotoMall' => 'http://onparking.sks-pens.site/img/grand-city.jpg'],
            ['namaMall' => 'Galaxy Mall Surabaya', 'alamatMall' => 'Jl. Dharmahusada Indah Timur No. 35-37 (Jl. Dr. Ir. H. Soekarno), Kota Surabaya', 'openTimeMall' => '11:00 - 20:00', 'fotoMall' => 'http://onparking.sks-pens.site/img/galaxy-mall.jpg'],
            ...
            ['namaMall' => 'WTC Surabaya', 'alamatMall' => 'Jl. Pemuda No.27-31, Embong Kaliasin, Kec. Genteng, Kota SBY', 'openTimeMall' => '11:00 - 20:00', 'fotoMall' => 'https://kfmap.asia/thumbs/photos/ID.SRB.OF.WTC/ID.SRB.OF.WTC_1.jpg'],
        ...
        User::insert([
            'name' => 'Admin', 'email' => 'admin@sks-pens.site', 'password' => '$2y$10$Gd2efjIgucmJI1/2TSYG3eH9y2HWbfRx.tSfdHEF8wz/mC0EIDZxy', 'role' => '1', 'card_id' => '000001'
        ]);
        User::insert([
            'name' => 'Arief', 'email' => 'arief.d2202@gmail.com', 'password' => '$2y$10$Gd2efjIgucmJI1/2TSYG3eH9y2HWbfRx.tSfdHEF8wz/mC0EIDZxy', 'role' => '0', 'card_id' => '000002'
        ]);
    }
}
