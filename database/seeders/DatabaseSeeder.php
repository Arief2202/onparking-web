...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        User::insert([
            'name' => 'Admin', 'email' => 'admin@eepis.tech', 'password' => '$2y$10$Gd2efjIgucmJI1/2TSYG3eH9y2HWbfRx.tSfdHEF8wz/mC0EIDZxy', 'role' => '1', 'card_id' => '000001'
        ]);
        User::insert([
            'name' => 'Arief', 'email' => 'arief.d2202@gmail.com', 'password' => '$2y$10$Gd2efjIgucmJI1/2TSYG3eH9y2HWbfRx.tSfdHEF8wz/mC0EIDZxy', 'role' => '0', 'card_id' => '95:FD:93:12'
        ]);
